...
CodeViewer.prototype.showViewAndCode = function() {
    $('#canvasContainer, #codeContainer, #buttonsCode, #bottom').fadeOut(600)
.hide();
	$('#bottom').width('100%');
...
.hide();
    $('#buttons').after($('#bottom').detach());
	$('#canvasContainer, #bottom').width('100%')
.fadeIn(600);
	this.updateCanvasSize();
	this.mode = this.MODE_VIEW;
...
CodeViewer.prototype.updateGUI = function() {
    ...
    const buttons_code = document.createElement('div');
    ...
    const buttons_canvas = document.createElement('div');
    buttons_canvas.id = 'buttonsCanvas';

    const btnFullView = document.createElement('input');
	...
	const btnShowCode = document.createElement('input');
	...
	const btnShowControls = document.createElement('input');
    ...
    const code_area = document.createElement('code');
